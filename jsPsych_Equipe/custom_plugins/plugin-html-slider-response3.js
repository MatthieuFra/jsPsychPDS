var jsPsychHtmlSliderResponse3 = (function (jspsych) {
  'use strict';
  ...
  class HtmlSliderResponsePlugin {
      ...
      trial(display_element, trial) {
          ...
          console.log(display_element.querySelector('#jspsych-html-slider-response-response').valueAsNumber); 
          display_element.querySelector('#jspsych-html-slider-response-stimulus').textContent = display_element.querySelector('#jspsych-html-slider-response-response').valueAsNumber; 
            audio.pause()
            audio = new Audio(`0_ACDC2.mp3`);
            audio.loop = false;
            audio.volume = display_element.querySelector('#jspsych-html-slider-response-response').valueAsNumber/100 
            audio.play()
