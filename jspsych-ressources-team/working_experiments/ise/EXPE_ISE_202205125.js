...
PARAMETRES */
  ...
  `; 
   ...
   var sounds = [
     ...
     'seq_liss.wav',
     'seq_liss.wav',
     'seq_dev_pm20_position5.wav',
     'seq_dev_pm20_position6.wav',
     'seq_dev_pm20_position7.wav',
     'seq_dev_pm50_position5.wav',
     'seq_dev_pm50_position6.wav',
     'seq_dev_pm50_position7.wav',
     'seq_dev_pm100_position5.wav',
     'seq_dev_pm100_position6.wav',
     'seq_dev_pm100_position7.wav',
     ];
 ...
 var diffSerieCompute = {
      ...
      on_finish: function(){
        ...
        if(diffSerie === false){
          ...
          console.log(`ShuffleSounds 539 : ${shuffledSounds}`)
  ...
  timeline.push(diffSerieCompute);
     ...
     var preloadTask = {
      ...
      audio: function(){
        ...
        if(diffSerie === false){
          console.log(` Sound preload is : ${shuffledSounds[j-1]}`)
...
var htmlPrompt = `<p></p><p><i>Renseignez "<b>x</b>" à la place des chiffres oubliés.</i></p>
  <input name="rep1" id="focus" min="1" max="2" type="text" required="true" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px;"/>
  <input name="rep2" min="1" max="2" type="text" required="true" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px;"/>
  <input name="rep3" type="text" required="true" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px;"/>
  <input name="rep4" type="text" required="true" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px;"/>
  <input name="rep5" type="text" required="true" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px;"/>
  <input name="rep6" type="text" required="true" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px;"/>
  <input name="rep7" type="text" required="true" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px;"/>
  <input name="rep8" type="text" required="true" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px;"/>
  <input name="rep9" type="text" required="true" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px;"/>
  <p></p>`;
...
var funcHtml = {
  ...
  <div class="form-wrap">
  <input name="rep1" id="focus" min="1" max="2" type="text" required="true" maxlength="1" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px; text-align: center;"/>
  <input name="rep2" min="1" max="2" type="text" required="true" maxlength="1" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px; text-align: center;"/>
  <input name="rep3" type="text" required="true" maxlength="1" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px; text-align: center;"/>
  <input name="rep4" type="text" required="true" maxlength="1" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px; text-align: center;"/>
  <input name="rep5" type="text" required="true" maxlength="1" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px; text-align: center;"/>
  <input name="rep6" type="text" required="true" maxlength="1" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px; text-align: center;"/>
  <input name="rep7" type="text" required="true" maxlength="1" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px; text-align: center;"/>
  <input name="rep8" type="text" required="true" maxlength="1" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px; text-align: center;"/>
  <input name="rep9" type="text" required="true" maxlength="1" style="font-size:25px; display:inline; border-style:solid; border-color:#B1B6B7; width:35px; text-align: center;"/>
  </div>
  <p></p>
...
timeline.push(displayTraining); 
    ...
    var displayTraining2 = {
      ...
      stimulus: function(){
        ...
        <p>Vous aurez la possibilité de faire une pause après 12 séries de chiffres présentées. Il y a 2 séries en tout.</p>
        `
      },
      on_start: function(){
        training = "no"
    ...
    var displayCrossTraining = {
      ...
      on_start: function(){
         soundPlayed = soundTraining[y-1]
         audio = new Audio(soundTraining[y-1]);
         audio.loop = false;
         audio.play()
         return soundPlayed
      },
    ...
    var loopProcedureGlobal = {
      ...
      loop_function: function(){
        if(k < numbLoop){
          ...
          shuffledSounds = jsPsych.randomization.shuffle(sounds)
          console.log(`ShuffleSounds 1240 : ${shuffledSounds}`)
          return true
